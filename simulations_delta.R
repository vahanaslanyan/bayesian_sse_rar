...
#delta varies from 0.05 to 1
delta_stars<-seq(0.05,1,by=0.05)

for (delta_value in delta_stars){
...
write_csv(df_sample_size,"changing_delta_no_interim_analysis.csv")
write_csv(interim_ss50,"changing_delta_no_rar_interim_analysis50.csv")
write_csv(interim_ss_rar50,"changing_delta_rar_interim_analysis50.csv")
write_csv(interim_ss25,"changing_delta_no_rar_interim_analysis25.csv")
write_csv(interim_ss_rar25,"changing_delta_rar_interim_analysis25.csv")
write_csv(interim_ss125,"changing_delta_no_rar_interim_analysis125.csv")
write_csv(interim_ss_rar125,"changing_delta_rar_interim_analysis125.csv")
...
write_csv(interim_ss_rar50,"changing_delta_rar_interim_analyses25_50.csv")
...
write_csv(interim_ss_50,"changing_delta_no_rar_interim_analyses25_50.csv")
...
for(delta_value in delta_stars){
  ...
  for(i in 1:length(alpha)){
    aux<-sample_size_calculation(alpha_prior = alpha[i],beta_prior = beta[i], 
                                 eta=0.95, zeta=0.90, xi=0.95,
                                 r=c(1/4,1/4,1/4,1/4),
                                 q_prior=c(1,1,1,1),delta_star=delta_value)
    if(any(is.na(aux)))next
...
write_csv(interim_ss_rar75,"changing_delta_rar_interim_analyses25_75.csv")
...
write_csv(interim_ss_75,"changing_delta_no_rar_interim_analyses25_75.csv")
