...
#eta varies from 0.9 to 0.99
eta_stars<-seq(0.90,0.99,by=0.01)
for (eta_value in eta_stars){
  for(i in 1:length(alpha)){
    aux<-sample_size_calculation(alpha_prior = alpha[i],beta_prior = beta[i],
                                 eta=eta_value, zeta=0.9, xi=0.95,
                                 r=c(1/4,1/4,1/4,1/4),q_prior=c(1,1,1,1),
                                 delta_star=0.3)
    aux$eta<-eta_value
    #if sample size is above 100000, NA is generated and we skip that iteration
...
write_csv(df_sample_size,"changing_eta_no_interim_analysis.csv")
write_csv(interim_ss50,"changing_eta_no_rar_interim_analysis50.csv")
write_csv(interim_ss_rar50,"changing_eta_rar_interim_analysis50.csv")
write_csv(interim_ss25,"changing_eta_no_rar_interim_analysis25.csv")
write_csv(interim_ss_rar25,"changing_eta_rar_interim_analysis25.csv")
write_csv(interim_ss125,"changing_eta_no_rar_interim_analysis125.csv")
write_csv(interim_ss_rar125,"changing_eta_rar_interim_analysis125.csv")
...
for (eta_value in eta_stars){
  ...
  for(i in 1:length(alpha)){
    ...
    aux<-sample_size_calculation(alpha_prior = alpha[i],beta_prior = beta[i],
                                 eta=eta_value, zeta=0.90, xi=0.95,
                                 r=c(1/4,1/4,1/4,1/4),
                                 q_prior=c(1,1,1,1),
                                 delta_star=0.3)
    if(any(is.na(aux)))next
...
write_csv(interim_ss_rar50,"changing_eta_rar_interim_analyses25_50.csv")
...
for(eta_value in eta_stars){
  ...
  for(i in 1:length(alpha)){
    ...
    df_alpha_beta_posteriors_50<-aux_post_50$alpha_beta_params
    df_D_posteriors_50<-aux_post_50$D
    interim_aux<-sample_size_calculation(alpha_prior =df_alpha_beta_posteriors_50$alpha_posterior,beta_prior = df_alpha_beta_posteriors_50$beta_posterior, eta=eta_value, zeta=0.90, 
...
write_csv(interim_ss_50,"changing_eta_no_rar_interim_analyses25_50.csv")
...
write_csv(interim_ss_rar75,"changing_eta_rar_interim_analyses25_75.csv")
...
for(eta_value in eta_stars){
  ...
  for(i in 1:length(alpha)){
    ...
    df_alpha_beta_posteriors_25<-aux_post_25$alpha_beta_params
    df_D_posteriors_25<-aux_post_25$D
    interim_aux<-sample_size_calculation(alpha_prior =df_alpha_beta_posteriors_25$alpha_posterior ,beta_prior = df_alpha_beta_posteriors_25$beta_posterior, eta=eta_value, zeta=0.90, 
...
write_csv(interim_ss_75,"changing_eta_no_rar_interim_analyses25_75.csv")
