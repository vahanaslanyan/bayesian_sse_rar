...
ggplot(summary_delta_no_interim_plot,aes(x=delta_star,y=total_participants))+geom_point()+geom_line()+theme_bw()
...
ggplot(summary_delta_no_rar50_plot,aes(x=delta,y=total_participants))+geom_point()+geom_line() 


master_dataset<-rbind(summary_delta_no_interim,summary_delta_no_rar_50)
ggplot(master_dataset,aes(x=delta,y=total_participants,color=method))+geom_point()+geom_line()+theme_classic()+
...
ggplot(summary_delta_no_rar_25,aes(x=delta,y=total_participants))+geom_point()+geom_line()  
master_dataset<-rbind(master_dataset,summary_delta_no_rar_25)

ggplot(master_dataset,aes(x=delta,y=total_participants,color=method))+geom_point()+geom_line() 
...
ggplot(summary_delta_no_rar_125,aes(x=delta,y=total_participants))+geom_point()+geom_line() 
...
ggplot(summary_delta_no_rar_25_50,aes(x=delta,y=total_participants))+geom_point()+geom_line() 
...
ggplot(summary_delta_no_rar_25_75,aes(x=delta,y=total_participants))+geom_point()+geom_line() 
...
p1<-ggplot(master_dataset,aes(x=delta,y=total_participants,color=method))+geom_point()+geom_line()+theme_classic()+
  ylab("Total Number of Participants")+
  theme(legend.position = "bottom")+xlab("δ*")+theme(text = element_text(size=36))+
...
p2<-ggplot(master_dataset_small_delta,aes(x=delta,y=total_participants,color=method))+geom_point()+geom_line()+theme_classic()+
  ylab("Total Number of Participants")+
  theme(legend.position = "bottom")+xlab("δ*")+theme(text = element_text(size=36))+
  labs(color="Interim Analysis") +scale_color_jama()

p3<-ggplot(master_dataset_large_delta,aes(x=delta,y=total_participants,color=method))+geom_point()+geom_line()+theme_classic()+
  ylab("Total Number of Participants")+
  theme(legend.position = "bottom")+xlab("δ*")+theme(text = element_text(size=36))+
  labs(color="Interim Analysis") +scale_color_jama()
...
ggplot(summary_delta_rar50_plot,aes(x=delta,y=total_participants))+geom_point()+geom_line() 


master_dataset_rar<-rbind(summary_delta_no_interim,summary_delta_rar_50)
ggplot(master_dataset_rar,aes(x=delta,y=total_participants,color=method))+geom_point()+geom_line() 
...
ggplot(summary_delta_rar_25,aes(x=delta,y=total_participants))+geom_point()+geom_line()  
master_dataset_rar<-rbind(master_dataset_rar,summary_delta_rar_25)

ggplot(master_dataset_rar,aes(x=delta,y=total_participants,color=method))+geom_point()
...
ggplot(summary_delta_rar_125,aes(x=delta,y=total_participants))+geom_point()+geom_line() 
...
ggplot(summary_delta_rar_25_50,aes(x=delta,y=total_participants))+geom_point()+geom_line() 
...
ggplot(summary_delta_rar_25_75,aes(x=delta,y=total_participants))+geom_point()+geom_line() 
...
p4<-ggplot(master_dataset_rar,aes(x=delta,y=total_participants,color=method))+geom_point()+geom_line()+theme_classic()+
  ylab("Total Number of Participants")+
  theme(legend.position = "bottom")+xlab("δ*")+theme(text = element_text(size=36))+
  labs(color="Interim Analysis") +scale_color_jama()
...
p5<-ggplot(master_dataset_small_delta_rar,aes(x=delta,y=total_participants,color=method))+geom_point()+geom_line()+theme_classic()+
  ylab("Total Number of Participants")+
  theme(legend.position = "bottom")+xlab("δ*")+theme(text = element_text(size=36))+
  labs(color="Interim Analysis") +scale_color_jama()

p6<-ggplot(master_dataset_large_delta_rar,aes(x=delta,y=total_participants,color=method))+geom_point()+geom_line()+theme_classic()+
  ylab("Total Number of Participants")+
  theme(legend.position = "bottom")+xlab("δ*")+theme(text = element_text(size=36))+
  labs(color="Interim Analysis") +scale_color_jama()
...
ggplot(summary_eta_no_interim_plot,aes(x=eta,y=total_participants))+geom_point()+geom_line()+theme_bw()
...
ggplot(summary_eta_no_rar50_plot,aes(x=eta,y=total_participants))+geom_point()+geom_line() 


master_dataset_eta<-rbind(summary_eta_no_interim,summary_eta_no_rar_50)
ggplot(master_dataset_eta,aes(x=eta,y=total_participants,color=method))+geom_point()+geom_line()+theme_classic()+
  ylab("Total Number of Participants")+
...
ggplot(summary_eta_no_rar_25,aes(x=eta,y=total_participants))+geom_point()+geom_line()  
master_dataset_eta<-rbind(master_dataset_eta,summary_eta_no_rar_25)

ggplot(master_dataset_eta,aes(x=eta,y=total_participants,color=method))+geom_point()+geom_line() 
...
ggplot(summary_eta_no_rar_125,aes(x=eta,y=total_participants))+geom_point()+geom_line() 
...
ggplot(summary_eta_no_rar_25_50,aes(x=eta,y=total_participants))+geom_point()+geom_line() 
...
ggplot(summary_eta_no_rar_25_75,aes(x=eta,y=total_participants))+geom_point()+geom_line() 

master_dataset_eta<-rbind(master_dataset_eta,summary_eta_no_rar_25_75)

p7<-ggplot(master_dataset_eta,aes(x=eta,y=total_participants,color=method))+geom_point()+geom_line()+theme_classic()+
  ylab("Total Number of Participants")+
...
ggplot(summary_eta_rar50_plot,aes(x=eta,y=total_participants))+geom_point()+geom_line() 


master_dataset_eta_rar<-rbind(summary_eta_no_interim,summary_eta_rar_50)
ggplot(master_dataset_eta_rar,aes(x=eta,y=total_participants,color=method))+geom_point()+geom_line() 
...
ggplot(summary_eta_rar_25,aes(x=eta,y=total_participants))+geom_point()+geom_line()  
master_dataset_eta_rar<-rbind(master_dataset_eta_rar,summary_eta_rar_25)

ggplot(master_dataset_eta_rar,aes(x=eta,y=total_participants,color=method))+geom_point()
...
ggplot(summary_eta_rar_125,aes(x=eta,y=total_participants))+geom_point()+geom_line() 
...
ggplot(summary_eta_rar_25_50,aes(x=eta,y=total_participants))+geom_point()+geom_line() 
...
ggplot(summary_eta_rar_25_75,aes(x=eta,y=total_participants))+geom_point()+geom_line() 
...
p8<-ggplot(master_dataset_eta_rar,aes(x=eta,y=total_participants,color=method))+geom_point()+geom_line()+theme_classic()+
  ylab("Total Number of Participants")+
  theme(legend.position = "bottom")+xlab("η")+theme(text = element_text(size=36))+geom_vline(xintercept =0.95,linetype="dashed",color="gray")+
  labs(color="Interim Analysis")+scale_color_jama()
...
ggplot(summary_zeta_no_interim_plot,aes(x=zeta,y=total_participants))+geom_point()+geom_line()+theme_bw()
...
ggplot(summary_zeta_no_rar50_plot,aes(x=zeta,y=total_participants))+geom_point()+geom_line() 


master_dataset_zeta<-rbind(summary_zeta_no_interim,summary_zeta_no_rar_50)
ggplot(master_dataset_zeta,aes(x=zeta,y=total_participants,color=method))+geom_point()+geom_line()+theme_classic()+
  ylab("Total Number of Participants")+
...
ggplot(summary_zeta_no_rar_25,aes(x=zeta,y=total_participants))+geom_point()+geom_line()  
master_dataset_zeta<-rbind(master_dataset_zeta,summary_zeta_no_rar_25)

ggplot(master_dataset_zeta,aes(x=zeta,y=total_participants,color=method))+geom_point()+geom_line() 
...
ggplot(summary_zeta_no_rar_125,aes(x=zeta,y=total_participants))+geom_point()+geom_line() 
...
ggplot(summary_zeta_no_rar_25_50,aes(x=zeta,y=total_participants))+geom_point()+geom_line() 
...
ggplot(summary_zeta_no_rar_25_75,aes(x=zeta,y=total_participants))+geom_point()+geom_line() 

master_dataset_zeta<-rbind(master_dataset_zeta,summary_zeta_no_rar_25_75)

p9<-ggplot(master_dataset_zeta,aes(x=zeta,y=total_participants,color=method))+geom_point()+geom_line()+theme_classic()+
  ylab("Total Number of Participants")+
...
ggplot(summary_zeta_rar50_plot,aes(x=zeta,y=total_participants))+geom_point()+geom_line() 


master_dataset_zeta_rar<-rbind(summary_zeta_no_interim,summary_zeta_rar_50)
ggplot(master_dataset_zeta_rar,aes(x=zeta,y=total_participants,color=method))+geom_point()+geom_line() 
...
ggplot(summary_zeta_rar_25,aes(x=zeta,y=total_participants))+geom_point()+geom_line()  
master_dataset_zeta_rar<-rbind(master_dataset_zeta_rar,summary_zeta_rar_25)

ggplot(master_dataset_zeta_rar,aes(x=zeta,y=total_participants,color=method))+geom_point()
...
ggplot(summary_zeta_rar_125,aes(x=zeta,y=total_participants))+geom_point()+geom_line() 
...
ggplot(summary_zeta_rar_25_50,aes(x=zeta,y=total_participants))+geom_point()+geom_line() 
...
ggplot(summary_zeta_rar_25_75,aes(x=zeta,y=total_participants))+geom_point()+geom_line() 
...
p10<-ggplot(master_dataset_zeta_rar,aes(x=zeta,y=total_participants,color=method))+geom_point()+geom_line()+theme_classic()+
  ylab("Total Number of Participants")+
  theme(legend.position = "bottom")+xlab("ζ")+theme(text = element_text(size=36))+geom_vline(xintercept =0.90,linetype="dashed",color="gray")+
  labs(color="Interim Analysis")+scale_color_jama() 
...
ggplot(summary_xi_no_interim_plot,aes(x=xi,y=total_participants))+geom_point()+geom_line()+theme_bw()
...
ggplot(summary_xi_no_rar50_plot,aes(x=xi,y=total_participants))+geom_point()+geom_line() 


master_dataset_xi<-rbind(summary_xi_no_interim,summary_xi_no_rar_50)
ggplot(master_dataset_xi,aes(x=xi,y=total_participants,color=method))+geom_point()+geom_line()+theme_classic()+
  ylab("Total Number of Participants")+
  theme(legend.position = "bottom")+xlab("ζ")+theme(text = element_text(size=36))+
  labs(color="Interim Analysis")
...
ggplot(summary_xi_no_rar_25,aes(x=xi,y=total_participants))+geom_point()+geom_line()  
master_dataset_xi<-rbind(master_dataset_xi,summary_xi_no_rar_25)

ggplot(master_dataset_xi,aes(x=xi,y=total_participants,color=method))+geom_point()+geom_line() 
...
ggplot(summary_xi_no_rar_125,aes(x=xi,y=total_participants))+geom_point()+geom_line() 
...
ggplot(summary_xi_no_rar_25_50,aes(x=xi,y=total_participants))+geom_point()+geom_line() 
...
ggplot(summary_xi_no_rar_25_75,aes(x=xi,y=total_participants))+geom_point()+geom_line() 

master_dataset_xi<-rbind(master_dataset_xi,summary_xi_no_rar_25_75)

p11<-ggplot(master_dataset_xi,aes(x=xi,y=total_participants,color=method))+geom_point()+geom_line()+theme_classic()+
  ylab("Total Number of Participants")+
...
ggplot(summary_xi_rar50_plot,aes(x=xi,y=total_participants))+geom_point()+geom_line() 


master_dataset_xi_rar<-rbind(summary_xi_no_interim,summary_xi_rar_50)
ggplot(master_dataset_xi_rar,aes(x=xi,y=total_participants,color=method))+geom_point()+geom_line() 
...
ggplot(summary_xi_rar_25,aes(x=xi,y=total_participants))+geom_point()+geom_line()  
master_dataset_xi_rar<-rbind(master_dataset_xi_rar,summary_xi_rar_25)

ggplot(master_dataset_xi_rar,aes(x=xi,y=total_participants,color=method))+geom_point()
...
ggplot(summary_xi_rar_125,aes(x=xi,y=total_participants))+geom_point()+geom_line() 
...
ggplot(summary_xi_rar_25_50,aes(x=xi,y=total_participants))+geom_point()+geom_line() 
...
ggplot(summary_xi_rar_25_75,aes(x=xi,y=total_participants))+geom_point()+geom_line() 
...
p12<-ggplot(master_dataset_xi_rar,aes(x=xi,y=total_participants,color=method))+geom_point()+geom_line()+theme_classic()+
  ylab("Total Number of Participants")+
  theme(legend.position = "bottom")+xlab("ξ")+theme(text = element_text(size=36))+geom_vline(xintercept =0.95,linetype="dashed",color="gray")+
  labs(color="Interim Analysis")+scale_color_jama() 
...
ggsave("Delta_stars0814.svg",p13,height = 20,width = 36,dpi=600)
...
ggsave("eta_zeta_xi0814.svg",p14,height = 20,width = 36,dpi=600)
